...
def add_SearchServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'searchpb.SearchService', rpc_method_handlers)
...
class SearchService(object):
    ...
    def Search(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/searchpb.SearchService/Search',
